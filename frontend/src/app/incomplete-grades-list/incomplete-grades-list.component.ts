...
@Component({
  selector: 'app-incomplete-grades-list',
  templateUrl: './incomplete-grades-list.component.html',
  styleUrls: ['./incomplete-grades-list.component.css'],
})
export class IncompleteGradesListComponent {
